...
if __name__ == "__main__":
    ...
    p = inference_pipeline.run_inference("DeepLabV3_ResNet50", image_list)
    end_time = time.time()
    print(f"Stage 1_DEEPLAB Time: {end_time - start_time}")
    start_time = time.time()
    p2 = inference_pipeline.run_inference("YOLOv8s-seg", image_list)
    end_time = time.time()
    print(f"Stage 1_YOLO Time: {end_time - start_time}")
    start_time = time.time()
    # processes = []
    ...
    end_time = time.time()
    print(f"Stage 1 ensemble Time: {end_time - start_time}")
